...
<body>
  ...
  <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-lg">
      ...
      <form onsubmit="formEvent(event)" class="mb-0 mt-6 space-y-4 rounded-lg p-4 shadow-lg sm:p-6 lg:p-8">
        ...
        <div>
          ...
          <div class="relative">
            <input type="email" class="w-full rounded-lg border-gray-200 p-4 pe-12 text-sm shadow-sm"
              placeholder="Ingresar email" id="email" name="enail" required />
        ...
        <div>
          ...
          <div class="relative">
            <input type="password" class="w-full rounded-lg border-gray-200 p-4 pe-12 text-sm shadow-sm"
              placeholder="Ingresar contraseña" id="password" name="password" required />

            <button type="button" class="absolute inset-y-0 end-0 grid place-content-center px-4"
              onmousedown="showPassword()" onmouseup="hidePassword()" onmouseout="hidePassword()">
              <svg xmlns="http://www.w3.org/2000/svg" class="size-4 text-gray-400" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
<body>
  ...
  <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-lg">
      ...
      <form onsubmit="formEvent(event)" class="mb-0 mt-6 space-y-4 rounded-lg p-4 shadow-lg sm:p-6 lg:p-8">
        <p class="text-center text-lg font-medium">Crear nueva cuenta</p>
          ...
          <div class="relative">
            ...
            <span class="absolute inset-y-0 end-0 grid place-content-center px-4">
              <svg xmlns="http://www.w3.org/2000/svg" class="size-4 text-gray-400" fill="none" viewBox="0 0 24 24"
                ...
                <path d="M12 14C8.13401 14 5 17.134 5 21H19C19 17.134 15.866 14 12 14Z" stroke-linecap="round"
        ...
        <div>
          ...
          <div class="relative">
            <input type="email" class="w-full rounded-lg border-gray-200 p-4 pe-12 text-sm shadow-sm"
              placeholder="Enter email" id="email" name="enail" required />
        ...
        <div>
          ...
          <div class="relative">
            <input type="password" class="w-full rounded-lg border-gray-200 p-4 pe-12 text-sm shadow-sm"
              placeholder="Ingresar contraseña" id="password" name="password" required required minlength="8" />
        ...
        <div>
          ...
          <div class="relative">
            ...
            <button type="button" class="absolute inset-y-0 end-0 grid place-content-center px-4"
              onmousedown="showPasswordConfirmation()" onmouseup="hidePasswordConfirmation()"
              onmouseout="hidePasswordConfirmation()">
              <svg xmlns="http://www.w3.org/2000/svg" class="size-4 text-gray-400" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
        ...
        <p class="text-center text-sm text-gray-500">
          Ya tiene cuenta?
          <a class="underline" href="/auth/login">Iniciar Sesión</a>
        </p>
      </form>
    </div>
  </div>
      ...
      <div class="">
        ...
        <form onsubmit="formEvent(event)" class="mb-0 mt-6 space-y-4 rounded-lg p-4 shadow-lg sm:p-6 lg:p-8">
          <div>
            ...
            <div class="relative">
              <input type="text" class="w-full rounded-lg border-gray-200 p-4 pe-12 text-sm shadow-sm"
                placeholder="Nombres" id="name" name="name" value="<%= user.name %>" required />
          ...
          <div>
            ...
            <div class="relative">
              <input type="email" class="w-full rounded-lg border-gray-200 p-4 pe-12 text-sm shadow-sm"
                placeholder="Enter email" id="email" name="enail" value="<%= user.email %>" required />
            ...
            <tr>
              ...
              <td class="whitespace-nowrap w-4">
                <a href="user/edit/<%= user._id %>"
                  class="w-20 inline-block rounded bg-blue-600 px-4 py-2 text-xs font-medium text-white text-center hover:bg-indigo-700">
                  Editar
                </a>
              </td>
              <td class="whitespace-nowrap w-4">
                <button type="button" href="user/delete/<%= user._id %>" onclick="deleteUser('<%= user._id %>')"
                  class="w-20 inline-block rounded bg-blue-600 px-4 py-2 text-xs font-medium text-white text-center hover:bg-indigo-700">
                  Eliminar
                </button>
              </td>
  ...
  <div class="flex flex-1 items-center justify-end md:justify-between">
    <nav aria-label="Global" class="hidden md:block">
      <ul class="flex items-center gap-6 text-sm">
        <li>
          <a class="text-gray-500 transition hover:text-gray-500/75" href="/user">
            Usuarios
          </a>
        </li>
